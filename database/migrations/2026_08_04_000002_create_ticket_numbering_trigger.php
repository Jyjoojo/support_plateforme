...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                SET dernier_numero = compteurs_tickets.dernier_numero + 1
        ...
        DB::unprepared(<<<'SQL'
            CREATE TRIGGER tickets_generer_numero_before_insert
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS tickets_generer_numero_before_insert ON tickets');
        DB::unprepared('DROP FUNCTION IF EXISTS generer_numero_ticket()');
    }
};
